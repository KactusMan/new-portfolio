...
export const metadata = {
  title: "Contact Rayan Idrees | Hire Senior CMS Developer",
  description:
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Depending on my active contract commitments, I typically initiate new projects within 1–2 weeks following specification alignment and scope sign-off."
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap gap-4 font-mono text-xs text-lavender">
            ...
            <div className="bg-carbon px-3.5 py-2 rounded-xl border border-cosmic flex items-center gap-2">
              ...
              <span>Status: Available for Q3/Q4 Projects</span>
            </div>
          </div>
        </div>
      </section>
